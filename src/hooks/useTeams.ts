...
export function useTeamWithPlayers(teamSlug: string | undefined) {
  return useQuery({
    queryKey: ['team-with-players', teamSlug],
    queryFn: async () => {
...
export function useOppositionTeams(excludeSlug: string = 'glacis-united-fc') {
  return useQuery({
    queryKey: ['opposition-teams', excludeSlug],
    queryFn: async () => {
